...
var (
	//kernelDll           = syscall.MustLoadDLL("handshake.dll")
	kernelDll               = syscall.MustLoadDLL("handshake.dll")
	precomputeTableProcAddr = kernelDll.MustFindProc("handshake_cpu_setBlock_52").Addr()
	kernelProcAddr          = kernelDll.MustFindProc("handshake_hash_nonce").Addr()
)
